...
label_heading.place(relx=0.05, rely=0.4,anchor=W)
#Logo Image
...
fruit_dropdown.place(relx=0.95, rely=0.2, anchor= E)
...
#Total Cost
label_shadow_amount = Label(root ,bg="orange2", font=("Bahnschrift Light", 12))
label_shadow_amount.place(relx=0.95, rely=0.7, anchor= E)
#Quantity Label
label_shadow_quantity = Label(root ,bg="orange2", font=("Bahnschrift Light",12))
label_shadow_quantity.place(relx=0.95,rely=0.8, anchor= E)
class Juice:
    def __init__(self, fruit_name, quantity):
        self.fruit = fruit_name
        self.quantity = int(quantity)
        self.__cost = 250
    def __cacilateCost(self):
